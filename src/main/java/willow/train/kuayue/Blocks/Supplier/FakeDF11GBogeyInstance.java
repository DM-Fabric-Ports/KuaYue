...
public class FakeDF11GBogeyInstance extends KineticTileInstance<DF11GBogeyTileEntity> implements DynamicInstance {

    protected final RotatingData shaft;
    protected final ModelData wheel;
    protected float lastAngle = Float.NaN;

    public FakeDF11GBogeyInstance(MaterialManager modelManager, DF11GBogeyTileEntity tile) {
